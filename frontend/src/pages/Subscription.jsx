  ...
  return (
    <div className="w-full md:mt-0 md:p-10 py-10 flex flex-col  items-center justify-center">
      <div className="flex flex-col items-center justify-center p-10 rounded-2xl bg-white py-10">
        ...
        <div className="md:grid flex flex-col mt-6 justify-center items-center rounded-xl grid-cols-1 md:grid-cols-2 py-8 md:p-8">
            <div className="md:w-4/5 p-6 rounded-xl my-4 bg-[#cbf5dd]/50">
        ...
        <div className="mt-6 flex flex-col justify-center items-center">
            <strong className="md:text-3xl text-xl text-center font-mono">Become a Pro member for just 99/- per month</strong>
