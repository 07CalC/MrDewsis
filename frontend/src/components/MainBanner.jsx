...
export const MainBanner = () => {
    ...
    return(
        <div className="rounded-2xl p-4 md:flex grid justify-center items-center bg-white h-2/6 w-full">
            ...
            <img alt="img" src="https://res.cloudinary.com/dkhymc3li/image/upload/v1727280354/manchurian-Photoroom_tearfy.png" className="w-full"/>
            </div>
            ...
            <img alt="img" src="https://static.vecteezy.com/system/resources/previews/036/464/807/original/ai-generated-a-plate-of-fried-rice-isolated-on-a-transparent-background-top-view-cut-out-png.png" className="hidden md:flex w-full"/>
            </div>
        </div>
    )
}
